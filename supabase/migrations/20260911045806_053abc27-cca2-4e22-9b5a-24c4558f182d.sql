...
REVOKE ALL ON FUNCTION public.handle_report_gamification() FROM PUBLIC, anon, authenticated;
REVOKE ALL ON FUNCTION public.handle_report_verified_points() FROM PUBLIC, anon, authenticated;
REVOKE ALL ON FUNCTION public.award_points(uuid, integer, text, uuid) FROM PUBLIC, anon, authenticated;
